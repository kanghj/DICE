...
unsigned int* (*extract_response_codes)(unsigned char* buf, unsigned int buf_size, unsigned int num_to_read, unsigned int* state_count_ref) = NULL;
...
//  else if (!strcmp(argv[2], "DTLS12")) extract_response_codes = &extract_response_codes_dtls12;
  ...
  fprintf(stderr,"\n extract response codes");
  state_sequence = (*extract_response_codes)(response_buf, response_buf_size, 1000, &state_count);
  fprintf(stderr,"\n exited extract response codes");
